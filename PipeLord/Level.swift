...
//            board.pieces.append(piece10)
        ...
        case "basic": //Moving the entrance and exits
            ...
            let entrance1 = Piece(indexes: Indexes(x: 1, y: 2), shape: .entrance, colors: [UIColor.red], version: 1, isLocked: false, doesPivot: false)
            ...
            let entrance3 = Piece(indexes: Indexes(x: 3, y: 2), shape: .entrance, colors: [UIColor.cyan], version: 1, isLocked: false, doesPivot: false)
...
//            board.pieces.append(exit2)
        ...
        case "lucky guess"://8
            ...
            let exit = Piece(indexes: Indexes(x: 4, y: 5), shape: .exit, colors: [UIColor.red], version: 1,  isLocked: false, doesPivot: false)
            board.pieces.append(exit)
        ...
        case "infinite": //9
            ...
            let entrance = Piece(indexes: Indexes(x: 2, y: 4), shape: .entrance, colors: [UIColor.red], version: 4, isLocked: false, doesPivot: true)
            board.pieces.append(entrance)

            let exit = Piece(indexes: Indexes(x: 2, y: 3), shape: .exit, colors: [UIColor.red], version: 4,  isLocked: false, doesPivot: true)
            board.pieces.append(exit)
        ...
        case "snakey":
            ...
            let entrance = Piece(indexes: Indexes(x: 1, y: 2), shape: .entrance, colors: [UIColor.cyan], version: 1, isLocked: true, doesPivot: false)
            board.pieces.append(entrance)
        ...
        case "test7":
            ...
            let entrance = Piece(indexes: Indexes(x: 3, y: 4), shape: .entrance, colors: [UIColor.red], version: 3, isLocked: false, doesPivot: false)
            board.pieces.append(entrance)
            
            let exit = Piece(indexes: Indexes(x: 3, y: 8), shape: .exit, colors: [UIColor.red], version: 1, isLocked: false, doesPivot: false)
            board.pieces.append(exit)
...
//            board.pieces.append(exit4)
        ...
        case "zigzag":
            ...
            let entrance = Piece(indexes: Indexes(x: 1, y: 0), shape: .entrance, colors: [UIColor.red], version: 1, isLocked: true, doesPivot: false)
            board.pieces.append(entrance)
        ...
        case "puzzle":
            ...
            let entrance2 = Piece(indexes: Indexes(x: 3, y: 8), shape: .entrance, colors: [UIColor.cyan], version: 1, isLocked: false, doesPivot: false)
            board.pieces.append(entrance2)
            ...
            let piece1 = Piece(indexes: Indexes(x: 2, y: 1), shape: .stick, colors: [UIColor.red], version: 1, isLocked: false, doesPivot: false)
            board.pieces.append(piece1)
            
            let piece2 = Piece(indexes: Indexes(x: 2, y: 3), shape: .stick, colors: [UIColor.red], version: 1, isLocked: false, doesPivot: false)
            board.pieces.append(piece2)
            
            let piece3 = Piece(indexes: Indexes(x: 3, y: 2), shape: .stick, colors: [UIColor.red], version: 2, isLocked: false, doesPivot: false)
            board.pieces.append(piece3)
        ...
        case "test10":
            ...
            let exit = Piece(indexes: Indexes(x: 2, y: 3), shape: .exit, colors: [UIColor.cyan], version: 4,  isLocked: false, doesPivot: true)
            board.pieces.append(exit)

            let piece1 = Piece(indexes: Indexes(x: 0, y: 3), shape: .elbow, colors: [UIColor.cyan], version: 4, isLocked: true, doesPivot: true)
            board.pieces.append(piece1)

            let piece2 = Piece(indexes: Indexes(x: 0, y: 1), shape: .elbow, colors: [UIColor.cyan], version: 3, isLocked: true, doesPivot: true)
            board.pieces.append(piece2)

            let piece3 = Piece(indexes: Indexes(x: 1, y: 1), shape: .elbow, colors: [UIColor.cyan], version: 2, isLocked: true, doesPivot: true)
            board.pieces.append(piece3)
            
            let piece2a = Piece(indexes: Indexes(x: 0, y: 2), shape: .stick, colors: [UIColor.cyan], version: 3, isLocked: true, doesPivot: true)
            board.pieces.append(piece2a)

            let piece3a = Piece(indexes: Indexes(x: 1, y: 2), shape: .stick, colors: [UIColor.red, UIColor.cyan], version: 2, isLocked: true, doesPivot: true)
            ...
            let piece8 = Piece(indexes: Indexes(x: 1, y: 3), shape: .cross, colors: [UIColor.red, UIColor.cyan], version: 1, isLocked: false, doesPivot: true)
            board.pieces.append(piece8)
        ...
        case "Around and back":
            ...
            let entrance = Piece(indexes: Indexes(x: 1, y: 6), shape: .entrance, colors: [UIColor.red], version: 1, isLocked: false, doesPivot: false)
            board.pieces.append(entrance)
